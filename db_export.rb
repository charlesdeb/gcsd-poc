# rows for en locale
I18n.locale = en
User.where({ 'email' => 'chabekah@gmail.com', 'first_name' => 'Charles', 'last_name' => 'de Bueger', 'role' => 'user',
             'time_zone' => 'London', 'locale' => 'tr' }).first_or_create!
SessionType.where({ 'name' => 'Plenary', 'description' => 'Keynote session for allcomers',
                    'order_by' => 10 }).first_or_create!
...
Event.where(
  { 'title' => 'GCSD April 2022', 'starting_at' => 'Sun, 10 Apr 2022 07:00:00.000000000 UTC +00:00',
    'status' => 'published', 'is_featured' => false, 'slug' => 'gcsd-april-2022',
...
Event.where(
  { 'title' => 'GCSD October 2023', 'starting_at' => 'Sat, 08 Apr 2023 07:00:00.000000000 UTC +00:00',
    'status' => 'published', 'is_featured' => true, 'slug' => 'gcsd-april-2023',
...
I18n.locale = tr
User.where(
  { 'email' => 'chabekah@gmail.com', 'first_name' => 'Charles', 'last_name' => 'de Bueger', 'role' => 'user',
    'time_zone' => 'London', 'locale' => 'tr' }
).first_or_create!
SessionType.where({ 'name' => 'Plenary', 'description' => 'Keynote session for allcomers',
                    'order_by' => 10 }).first_or_create!
SessionType.where({ 'name' => 'Workshops', 'description' => 'xxx', 'order_by' => 10 }).first_or_create!
