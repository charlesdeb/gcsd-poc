...
/**
   ...
   * @return {string}
   */toFormat(e,t={}){const n={...t,floor:false!==t.round&&false!==t.floor};return this.isValid?Formatter.create(this.loc,n).formatDurationFromString(this,e):Fe}
/**
...
/**
   ...
   * @return {number}
   */as(e){return this.isValid?this.shiftTo(e).get(e):NaN}normalize(){if(!this.isValid)return this;const e=this.toObject();normalizeValues(this.matrix,e);return clone$1(this,{values:e},true)}rescale(){if(!this.isValid)return this;const e=removeZeroes(this.normalize().shiftToAll().toObject());return clone$1(this,{values:e},true)}shiftTo(...e){if(!this.isValid)return this;if(0===e.length)return this;e=e.map((e=>Duration.normalizeUnit(e)));const t={},n={},r=this.toObject();let s;for(const i of Ue)if(e.indexOf(i)>=0){s=i;let e=0;for(const t in n){e+=this.matrix[t][i]*n[t];n[t]=0}isNumber(r[i])&&(e+=r[i]);const a=Math.trunc(e);t[i]=a;n[i]=(1e3*e-1e3*a)/1e3;for(const e in r)Ue.indexOf(e)>Ue.indexOf(i)&&convert(this.matrix,r,e,t,i)}else isNumber(r[i])&&(n[i]=r[i]);for(const e in n)0!==n[e]&&(t[s]+=e===s?n[e]:n[e]/this.matrix[s][e]);return clone$1(this,{values:t},true).normalize()}shiftToAll(){return this.isValid?this.shiftTo("years","months","weeks","days","hours","minutes","seconds","milliseconds"):this}negate(){if(!this.isValid)return this;const e={};for(const t of Object.keys(this.values))e[t]=0===this.values[t]?0:-this.values[t];return clone$1(this,{values:e},true)}
/**
   * Get the years.
   * @type {number}
...
/**
   ...
   * @return {DateTime}
   */static fromObject(e,t={}){e=e||{};const n=normalizeZone(t.zone,Settings.defaultZone);if(!n.isValid)return DateTime.invalid(unsupportedZone(n));const r=Settings.now(),s=isUndefined(t.specificOffset)?n.offset(r):t.specificOffset,i=normalizeObject(e,normalizeUnit),a=!isUndefined(i.ordinal),o=!isUndefined(i.year),u=!isUndefined(i.month)||!isUndefined(i.day),l=o||u,c=i.weekYear||i.weekNumber,d=Locale.fromObject(t);if((l||a)&&c)throw new ConflictingSpecificationError("Can't mix weekYear/weekNumber units with year/month/day or ordinals");if(u&&a)throw new ConflictingSpecificationError("Can't mix ordinal dates with month/day");const m=c||i.weekday&&!l;let h,f,y=tsToObj(r,s);if(m){h=nt;f=Xe;y=gregorianToWeek(y)}else if(a){h=rt;f=et;y=gregorianToOrdinal(y)}else{h=tt;f=Ke}let g=false;for(const e of h){const t=i[e];isUndefined(t)?i[e]=g?f[e]:y[e]:g=true}const p=m?hasInvalidWeekData(i):a?hasInvalidOrdinalData(i):hasInvalidGregorianData(i),T=p||hasInvalidTimeData(i);if(T)return DateTime.invalid(T);const w=m?weekToGregorian(i):a?ordinalToGregorian(i):i,[O,S]=objToTS(w,s,n),v=new DateTime({ts:O,zone:n,o:S,loc:d});return i.weekday&&l&&e.weekday!==v.weekday?DateTime.invalid("mismatched weekday",`you can't specify both a weekday of ${i.weekday} and a date of ${v.toISO()}`):v}
/**
...
/**
   ...
   * @type {Object}
   */static get DATETIME_HUGE_WITH_SECONDS(){return I}}function friendlyDateTime(e){if(DateTime.isDateTime(e))return e;if(e&&e.valueOf&&isNumber(e.valueOf()))return DateTime.fromJSDate(e);if(e&&"object"===typeof e)return DateTime.fromObject(e);throw new InvalidArgumentError(`Unknown datetime argument: ${e}, of type ${typeof e}`)}const st="3.1.0";export{DateTime,Duration,FixedOffsetZone,IANAZone,Info,Interval,InvalidZone,Settings,SystemZone,st as VERSION,Zone};
