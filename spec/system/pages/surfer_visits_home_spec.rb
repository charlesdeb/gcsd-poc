...
RSpec.feature 'Surfer visits home page' do
  ...
  context('there are future events') do
    ...
    scenario 'they see a link for future events' do
      ...
      # TODO: i18n this
      expect(page).to have_link 'Future Events', href: future_events_path(locale: I18n.default_locale)
    end
  end
  ...
  context('there are no future events') do
    scenario 'they see no link for future events' do
      ...
      # TODO: i18n this
      expect(page).not_to have_link 'Future Events', href: future_events_path(locale: I18n.default_locale)
    end
  end
