...
Rails.application.configure do
  ...
  # an attempt to use tigris didn't work since Rails still seemed to need a
  # region setting, which while set, wasn't being recognised.
  ...
  # config.active_job.queue_name_prefix = "gcsd_production"
